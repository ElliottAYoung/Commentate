...
users.each do |user|
  videos << Video.create!(video_name: Faker::Company.catch_phrase, video_url: "http://youtu.be/5HRgfxDtaPI", description: Faker::Lorem.paragraph, rating: 5, user_id: user.id) 
  videos << Video.create!(video_name: Faker::Company.catch_phrase, video_url: "http://youtu.be/5HRgfxDtaPI", description: Faker::Lorem.paragraph, rating: 5, user_id: user.id) 
end
